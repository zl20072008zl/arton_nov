...
@Component({
    selector: 'jhi-admin-account-dialog',
...
@Component({
    selector: 'jhi-admin-account-popup',
    template: ''
})
export class AdminAccountPopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.modalRef = this.expressAccountPopupService
                    .open(AdminAccountDialogComponent, params[1]);
            } else {
                this.modalRef = this.expressAccountPopupService
                    .open(AdminAccountDialogComponent);
            }
        });
    }
