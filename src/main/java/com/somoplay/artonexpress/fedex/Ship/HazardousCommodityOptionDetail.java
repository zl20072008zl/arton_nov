...
public class HazardousCommodityOptionDetail  implements java.io.Serializable {
    ...
    private HazardousCommodityLabelTextOptionType labelTextOption;
    ...
    public HazardousCommodityOptionDetail(
           HazardousCommodityLabelTextOptionType labelTextOption,
     ...
     * for this commodity in this package.
     */
    public void setLabelTextOption(HazardousCommodityLabelTextOptionType labelTextOption) {
        this.labelTextOption = labelTextOption;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "HazardousCommodityOptionDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("labelTextOption");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "LabelTextOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "HazardousCommodityLabelTextOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("customerSuppliedLabelText");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "CustomerSuppliedLabelText"));
