...
public class EmailOptionsRequested  implements java.io.Serializable {
    private EmailOptionType[] options;

    public EmailOptionsRequested() {
    }

    public EmailOptionsRequested(
           EmailOptionType[] options) {
     ...
     * @return options
     */
    public EmailOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(EmailOptionType[] options) {
        this.options = options;
    }

    public EmailOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, EmailOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EmailOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EmailOptionType"));
