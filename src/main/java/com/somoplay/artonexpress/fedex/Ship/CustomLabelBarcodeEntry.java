...
public class CustomLabelBarcodeEntry  implements java.io.Serializable {
    ...
    private BarcodeSymbologyType barcodeSymbology;
     ...
     */
    public void setBarcodeSymbology(BarcodeSymbologyType barcodeSymbology) {
        this.barcodeSymbology = barcodeSymbology;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "CustomLabelBarcodeEntry"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BarHeight"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ThinBarWidth"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BarcodeSymbology"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BarcodeSymbologyType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
