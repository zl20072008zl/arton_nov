...
public class EdtCommodityTax  implements java.io.Serializable {
     ...
     * @param taxes
     */
    public void setTaxes(EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EdtCommodityTax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EdtTaxDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
