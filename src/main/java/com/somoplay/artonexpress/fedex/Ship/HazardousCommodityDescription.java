...
public class HazardousCommodityDescription  implements java.io.Serializable {
    ...
    public HazardousCommodityDescription(
           ...
           HazardousCommodityPackingDetail packingDetails,
           ...
           HazardousCommodityDescriptionProcessingOptionType[] processingOptions,
     ...
     */
    public void setPackingDetails(HazardousCommodityPackingDetail packingDetails) {
        this.packingDetails = packingDetails;
    }
     ...
     * description of the dangerous goods commodity.
     */
    public void setProcessingOptions(HazardousCommodityDescriptionProcessingOptionType[] processingOptions) {
        this.processingOptions = processingOptions;
    }
    ...
    public void setProcessingOptions(int i, HazardousCommodityDescriptionProcessingOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "HazardousCommodityDescription"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PackingDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "HazardousCommodityPackingDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reportableQuantity");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ReportableQuantity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Percentage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "HazardousCommodityDescriptionProcessingOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
