...
public class ValidatedHazardousContainer  implements java.io.Serializable {
    ...
    private ValidatedHazardousCommodityContent[] hazardousCommodities;
    ...
    public ValidatedHazardousContainer(
           ...
           ValidatedHazardousCommodityContent[] hazardousCommodities) {
           this.QValue = QValue;
     ...
     * in the current package.
     */
    public ValidatedHazardousCommodityContent[] getHazardousCommodities() {
     ...
     * in the current package.
     */
    public void setHazardousCommodities(ValidatedHazardousCommodityContent[] hazardousCommodities) {
        this.hazardousCommodities = hazardousCommodities;
    }

    public ValidatedHazardousCommodityContent getHazardousCommodities(int i) {
        return this.hazardousCommodities[i];
    }

    public void setHazardousCommodities(int i, ValidatedHazardousCommodityContent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ValidatedHazardousContainer"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("QValue");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "QValue"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ValidatedHazardousCommodityContent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
