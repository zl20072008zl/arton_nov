...
public class PackageRating  implements java.io.Serializable {
    ...
    private PackageRateDetail[] packageRateDetails;
    ...
    public PackageRating(
           ...
           PackageRateDetail[] packageRateDetails) {
     ...
     * for a specific rate type.
     */
    public PackageRateDetail[] getPackageRateDetails() {
     ...
     * for a specific rate type.
     */
    public void setPackageRateDetails(PackageRateDetail[] packageRateDetails) {
        this.packageRateDetails = packageRateDetails;
    }

    public PackageRateDetail getPackageRateDetails(int i) {
        return this.packageRateDetails[i];
    }

    public void setPackageRateDetails(int i, PackageRateDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PackageRating"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PackageRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PackageRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
