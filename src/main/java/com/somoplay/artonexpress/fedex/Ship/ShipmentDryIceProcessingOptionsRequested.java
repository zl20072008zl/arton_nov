...
public class ShipmentDryIceProcessingOptionsRequested  implements java.io.Serializable {
    private ShipmentDryIceProcessingOptionType[] options;

    public ShipmentDryIceProcessingOptionsRequested() {
    }

    public ShipmentDryIceProcessingOptionsRequested(
           ShipmentDryIceProcessingOptionType[] options) {
     ...
     * @return options
     */
    public ShipmentDryIceProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(ShipmentDryIceProcessingOptionType[] options) {
        this.options = options;
    }

    public ShipmentDryIceProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, ShipmentDryIceProcessingOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ShipmentDryIceProcessingOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ShipmentDryIceProcessingOptionType"));
