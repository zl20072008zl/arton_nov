...
public class ShipmentRating  implements java.io.Serializable {
    ...
    private ShipmentRateDetail[] shipmentRateDetails;
    ...
    public ShipmentRating(
           ...
           ShipmentRateDetail[] shipmentRateDetails) {
     ...
     * for a specific rate type.
     */
    public ShipmentRateDetail[] getShipmentRateDetails() {
     ...
     * for a specific rate type.
     */
    public void setShipmentRateDetails(ShipmentRateDetail[] shipmentRateDetails) {
        this.shipmentRateDetails = shipmentRateDetails;
    }

    public ShipmentRateDetail getShipmentRateDetails(int i) {
        return this.shipmentRateDetails[i];
    }

    public void setShipmentRateDetails(int i, ShipmentRateDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ShipmentRating"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actualRateType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ActualRateType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EffectiveNetDiscount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ShipmentRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ShipmentRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
