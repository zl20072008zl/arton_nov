...
public class RadionuclideActivity  implements java.io.Serializable {
    ...
    private RadioactivityUnitOfMeasure unitOfMeasure;
    ...
    public RadionuclideActivity(
           ...
           RadioactivityUnitOfMeasure unitOfMeasure) {
           this.value = value;
     ...
     * @param unitOfMeasure
     */
    public void setUnitOfMeasure(RadioactivityUnitOfMeasure unitOfMeasure) {
        this.unitOfMeasure = unitOfMeasure;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "RadionuclideActivity"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("value");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Value"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "UnitOfMeasure"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "RadioactivityUnitOfMeasure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
