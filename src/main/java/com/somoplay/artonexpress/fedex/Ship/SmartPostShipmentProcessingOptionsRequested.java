...
public class SmartPostShipmentProcessingOptionsRequested  implements java.io.Serializable {
    ...
    public SmartPostShipmentProcessingOptionsRequested(
           SmartPostShipmentProcessingOptionType[] options) {
     ...
     * @param options
     */
    public void setOptions(SmartPostShipmentProcessingOptionType[] options) {
        this.options = options;
    }
    ...
    public void setOptions(int i, SmartPostShipmentProcessingOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "SmartPostShipmentProcessingOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "SmartPostShipmentProcessingOptionType"));
