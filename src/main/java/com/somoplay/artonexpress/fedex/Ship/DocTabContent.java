...
public class DocTabContent  implements java.io.Serializable {
    private DocTabContentType docTabContentType;

    private DocTabContentZone001 zone001;

    private DocTabContentBarcoded barcoded;
    ...
    public DocTabContent(
           ...
           DocTabContentZone001 zone001,
           DocTabContentBarcoded barcoded) {
     ...
     */
    public void setDocTabContentType(DocTabContentType docTabContentType) {
        this.docTabContentType = docTabContentType;
    }
     ...
     * @param zone001
     */
    public void setZone001(DocTabContentZone001 zone001) {
        this.zone001 = zone001;
    }
     ...
     * @param barcoded
     */
    public void setBarcoded(DocTabContentBarcoded barcoded) {
        this.barcoded = barcoded;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabContent"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("docTabContentType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabContentType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabContentType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("zone001");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Zone001"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabContentZone001"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("barcoded");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Barcoded"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabContentBarcoded"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
