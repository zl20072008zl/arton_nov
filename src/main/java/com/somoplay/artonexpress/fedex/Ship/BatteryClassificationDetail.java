...
public class BatteryClassificationDetail  implements java.io.Serializable {
    ...
    public BatteryClassificationDetail(
           BatteryMaterialType material,
           BatteryPackingType packing,
           BatteryRegulatorySubType regulatorySubType) {
     ...
     */
    public void setMaterial(BatteryMaterialType material) {
        this.material = material;
    }
     ...
     * respect to other items within the same package.
     */
    public void setPacking(BatteryPackingType packing) {
        this.packing = packing;
    }
     ...
     */
    public void setRegulatorySubType(BatteryRegulatorySubType regulatorySubType) {
        this.regulatorySubType = regulatorySubType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BatteryClassificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("material");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Material"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BatteryMaterialType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("packing");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "Packing"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BatteryPackingType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("regulatorySubType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "RegulatorySubType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "BatteryRegulatorySubType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
