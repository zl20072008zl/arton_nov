...
public class ReturnEMailDetail  implements java.io.Serializable {
    ...
    private ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices;
     ...
     * controlled by this list.
     */
    public ReturnEMailAllowedSpecialServiceType[] getAllowedSpecialServices() {
     ...
     * controlled by this list.
     */
    public void setAllowedSpecialServices(ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices) {
        this.allowedSpecialServices = allowedSpecialServices;
    }

    public ReturnEMailAllowedSpecialServiceType getAllowedSpecialServices(int i) {
        return this.allowedSpecialServices[i];
    }

    public void setAllowedSpecialServices(int i, ReturnEMailAllowedSpecialServiceType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ReturnEMailDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("merchantPhoneNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "MerchantPhoneNumber"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "AllowedSpecialServices"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "ReturnEMailAllowedSpecialServiceType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
