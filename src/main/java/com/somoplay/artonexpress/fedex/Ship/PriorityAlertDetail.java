...
public class PriorityAlertDetail  implements java.io.Serializable {
    private PriorityAlertEnhancementType[] enhancementTypes;
    ...
    public PriorityAlertDetail(
           PriorityAlertEnhancementType[] enhancementTypes,
     ...
     */
    public PriorityAlertEnhancementType[] getEnhancementTypes() {
        return enhancementTypes;
    }
     ...
     */
    public void setEnhancementTypes(PriorityAlertEnhancementType[] enhancementTypes) {
        this.enhancementTypes = enhancementTypes;
    }

    public PriorityAlertEnhancementType getEnhancementTypes(int i) {
        return this.enhancementTypes[i];
    }

    public void setEnhancementTypes(int i, PriorityAlertEnhancementType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PriorityAlertDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("enhancementTypes");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EnhancementTypes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PriorityAlertEnhancementType"));
