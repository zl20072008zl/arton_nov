...
public class DocTabContentZone001  implements java.io.Serializable {
    private DocTabZoneSpecification[] docTabZoneSpecifications;

    public DocTabContentZone001() {
    }

    public DocTabContentZone001(
           DocTabZoneSpecification[] docTabZoneSpecifications) {
     ...
     */
    public DocTabZoneSpecification[] getDocTabZoneSpecifications() {
        return docTabZoneSpecifications;
    }
     ...
     */
    public void setDocTabZoneSpecifications(DocTabZoneSpecification[] docTabZoneSpecifications) {
        this.docTabZoneSpecifications = docTabZoneSpecifications;
    }

    public DocTabZoneSpecification getDocTabZoneSpecifications(int i) {
        return this.docTabZoneSpecifications[i];
    }

    public void setDocTabZoneSpecifications(int i, DocTabZoneSpecification _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabContentZone001"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("docTabZoneSpecifications");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabZoneSpecifications"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocTabZoneSpecification"));
