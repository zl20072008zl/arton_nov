...
public class EMailRecipient  implements java.io.Serializable {
    ...
    public EMailRecipient(
           ...
           EmailOptionsRequested optionsRequested,
     ...
     * need to be processed.
     */
    public void setOptionsRequested(EmailOptionsRequested optionsRequested) {
        this.optionsRequested = optionsRequested;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EMailRecipient"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "EmailOptionsRequested"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
