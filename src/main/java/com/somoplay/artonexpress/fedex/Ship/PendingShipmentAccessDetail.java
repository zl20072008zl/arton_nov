...
public class PendingShipmentAccessDetail  implements java.io.Serializable {
    private PendingShipmentAccessorDetail[] accessorDetails;

    public PendingShipmentAccessDetail() {
    }

    public PendingShipmentAccessDetail(
           PendingShipmentAccessorDetail[] accessorDetails) {
     ...
     */
    public PendingShipmentAccessorDetail[] getAccessorDetails() {
        return accessorDetails;
    }
     ...
     */
    public void setAccessorDetails(PendingShipmentAccessorDetail[] accessorDetails) {
        this.accessorDetails = accessorDetails;
    }

    public PendingShipmentAccessorDetail getAccessorDetails(int i) {
        return this.accessorDetails[i];
    }

    public void setAccessorDetails(int i, PendingShipmentAccessorDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PendingShipmentAccessDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("accessorDetails");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "AccessorDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "PendingShipmentAccessorDetail"));
