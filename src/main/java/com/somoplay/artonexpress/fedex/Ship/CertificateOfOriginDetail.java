...
public class CertificateOfOriginDetail  implements java.io.Serializable {
    ...
    public CertificateOfOriginDetail(
           ShippingDocumentFormat documentFormat,
     ...
     */
    public void setDocumentFormat(ShippingDocumentFormat documentFormat) {
        this.documentFormat = documentFormat;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "CertificateOfOriginDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("documentFormat");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v21", "DocumentFormat"));
