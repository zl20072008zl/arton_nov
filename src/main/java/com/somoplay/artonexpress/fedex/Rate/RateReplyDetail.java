...
public class RateReplyDetail  implements java.io.Serializable {
    ...
    public RateReplyDetail(
           ...
           DayOfWeekType deliveryDayOfWeek,
     ...
     */
    public void setDeliveryDayOfWeek(DayOfWeekType deliveryDayOfWeek) {
        this.deliveryDayOfWeek = deliveryDayOfWeek;
    }
     ...
     * @param commitDetails
     */
    public void setCommitDetails(CommitDetail[] commitDetails) {
        this.commitDetails = commitDetails;
    }
    ...
    public void setCommitDetails(int i, CommitDetail _value) {
