...
public class FlatbedTrailerDetail  implements java.io.Serializable {
    private FlatbedTrailerOption[] options;

    public FlatbedTrailerDetail() {
    }

    public FlatbedTrailerDetail(
           FlatbedTrailerOption[] options) {
     ...
     * @return options
     */
    public FlatbedTrailerOption[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(FlatbedTrailerOption[] options) {
        this.options = options;
    }

    public FlatbedTrailerOption getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, FlatbedTrailerOption _value) {
