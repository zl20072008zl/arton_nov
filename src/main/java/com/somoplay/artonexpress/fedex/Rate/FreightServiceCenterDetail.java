...
public class FreightServiceCenterDetail  implements java.io.Serializable {
    ...
    public FreightServiceCenterDetail(
           ...
           FreightServiceSchedulingType localServiceScheduling,
           DayOfWeekType[] limitedServiceDays,
     ...
     * distinct from service used for line-haul of customer's shipment.
     */
    public void setLocalService(ServiceType localService) {
        this.localService = localService;
    }
     ...
     * the supporting Freight / National Freight service center.
     */
    public void setLocalDistance(Distance localDistance) {
        this.localDistance = localDistance;
    }
     ...
     */
    public void setLocalServiceScheduling(FreightServiceSchedulingType localServiceScheduling) {
        this.localServiceScheduling = localServiceScheduling;
    }
     ...
     */
    public void setLimitedServiceDays(DayOfWeekType[] limitedServiceDays) {
        this.limitedServiceDays = limitedServiceDays;
    }
    ...
    public void setLimitedServiceDays(int i, DayOfWeekType _value) {
