...
public class ServiceSubOptionDetail  implements java.io.Serializable {
    ...
    private FreightGuaranteeType freightGuarantee;
     ...
     * is a variable option on the rate request. */
    private SmartPostIndiciaType smartPostIndicia;

    public ServiceSubOptionDetail() {
    }

    public ServiceSubOptionDetail(
           FreightGuaranteeType freightGuarantee,
           java.lang.String smartPostHubId,
           SmartPostIndiciaType smartPostIndicia) {
     ...
     * is applied to the rate quote.
     */
    public void setFreightGuarantee(FreightGuaranteeType freightGuarantee) {
        this.freightGuarantee = freightGuarantee;
    }
     ...
     * is a variable option on the rate request.
     */
    public void setSmartPostIndicia(SmartPostIndiciaType smartPostIndicia) {
        this.smartPostIndicia = smartPostIndicia;
    }
