...
public class FreightCommitDetail  implements java.io.Serializable {
    ...
    private FreightServiceCenterDetail originDetail;

    /* Information about the destination Freight Service Center. */
    private FreightServiceCenterDetail destinationDetail;
    ...
    public FreightCommitDetail(
           FreightServiceCenterDetail originDetail,
           FreightServiceCenterDetail destinationDetail,
     ...
     */
    public void setOriginDetail(FreightServiceCenterDetail originDetail) {
        this.originDetail = originDetail;
    }
     ...
     */
    public void setDestinationDetail(FreightServiceCenterDetail destinationDetail) {
        this.destinationDetail = destinationDetail;
    }
