...
public class RateServiceLocator extends org.apache.axis.client.Service implements RateService {
    ...
    public RatePortType getRateServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public RatePortType getRateServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            RateServiceSoapBindingStub _stub = new RateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (RatePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                RateServiceSoapBindingStub _stub = new RateServiceSoapBindingStub(new java.net.URL(RateServicePort_address), this);
                _stub.setPortName(getRateServicePortWSDDServiceName());
                return _stub;
            }
        }
