...
public class RatedShipmentDetail  implements java.io.Serializable {
    ...
    private RatedPackageDetail[] ratedPackages;
    ...
    public RatedShipmentDetail(
           ...
           RatedPackageDetail[] ratedPackages) {
     ...
     */
    public RatedPackageDetail[] getRatedPackages() {
     ...
     */
    public void setRatedPackages(RatedPackageDetail[] ratedPackages) {
        this.ratedPackages = ratedPackages;
    }

    public RatedPackageDetail getRatedPackages(int i) {
        return this.ratedPackages[i];
    }

    public void setRatedPackages(int i, RatedPackageDetail _value) {
