...
public class ExpressFreightDetail  implements java.io.Serializable {
    ...
    public ExpressFreightDetail(
           ...
           ExpressFreightDetailContact beforeDeliveryContact,
           ExpressFreightDetailContact undeliverableContact) {
     ...
     */
    public void setBeforeDeliveryContact(ExpressFreightDetailContact beforeDeliveryContact) {
        this.beforeDeliveryContact = beforeDeliveryContact;
    }
     ...
     */
    public void setUndeliverableContact(ExpressFreightDetailContact undeliverableContact) {
        this.undeliverableContact = undeliverableContact;
    }
