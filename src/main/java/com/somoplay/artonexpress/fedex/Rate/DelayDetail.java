...
public class DelayDetail  implements java.io.Serializable {
    ...
    public DelayDetail(
           ...
           DelayLevelType level,
           DelayPointType point,
           CommitmentDelayType type,
     ...
     * City, LocationId, Zip, service area, special handling )
     */
    public void setLevel(DelayLevelType level) {
        this.level = level;
    }
     ...
     * Broker location)
     */
    public void setPoint(DelayPointType point) {
        this.point = point;
    }
     ...
     */
    public void setType(CommitmentDelayType type) {
        this.type = type;
    }
